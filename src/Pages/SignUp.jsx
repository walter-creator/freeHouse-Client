...
//   const [error, setError] = useState("");
  ...
  return (
    <>
      ...
      <div
        className="page-headers align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
        style={divStyleUp}
      >
          ...
          <div className="row justify-content-center">
            <div className="col-lg-5 text-center mx-auto">
              ...
              <p className="text-lead text-white">
                Utilise ce formulaire pour avoir un compte et dire adieux aux
                problemes de logement.
              </p>
            </div>
          </div>
        </div>
